...
const Login = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Store token securely (consider cookies instead)
      window.sessionStorage.setItem("authToken", token);
      ...
      navigate(userData.role === "admin" ? "/admin/dashboard" : userData.role === "assistant" ? "/assistant/dashboard" : "/");
    } catch (err) {
        ...
        <div className={logStyles.content}>
          ...
          <div className={logStyles.data}>
            <form onSubmit={handleSubmit}>
              ...
              {error && <p className={logStyles.error}>{error}</p>}
